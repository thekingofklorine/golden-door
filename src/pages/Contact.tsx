  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>or <a href="https://docs.google.com/forms/d/e/1FAIpQLSdMAhH3HtUykwsWNXLNK7HgQVNQJhvlKbKgz_RrsOiX3o3IJA/viewform" target="_blank" rel="noopener noreferrer">click this link to fill out a survey</a>.</li>
      </ul>
    </div>
  );
}
